...
import pandas as pd
data=pd.read_csv('C:/Users/ftsv2/Desktop/2021/21KDT/21kdt 특강/prods 특강/Dataset/Dataset_01.csv')
...
data[['TV', 'Radio', 'Social_Media', 'Influencer', 'Sales']].corr()

Q2 = data [['TV', 'Radio', 'Social_Media', 'Influencer', 'Sales']].corr()
...
ols3 = ols('Sales~TV + Radio + Social_Media', dat = data1).fit()
ols3.summary()

ols4 = ols(form, dat = data1).fit()
ols4.summary()
